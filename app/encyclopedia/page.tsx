...
import { getKnowledgeArticles, getKnowledgeCategories, getKnowledgeArticlePath, getKnowledgeCategoryPath } from '@/lib/content';
      ...
      >
        ...
        <section className="console-window col-span-12">
          <div className="console-header">
            ...
            <span className="text-primary">DIRECTORY_ACTIVE</span>
          </div>
